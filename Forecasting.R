...
plot(Amtrak,type="o")
amtrakts<-ts(Amtrak[,2],start=c(91,1),frequency=12)
plot(amtrakts)
ggseasonplot(amtrakts,year.labels=TRUE,year.labels.left=TRUE)+ylab("degree")+ggtitle("seasonal plot:amtrak")
monthplot(amtrakts)
tsdecompose<-decompose(amtrakts,type="additive")
plot(tsdecompose)
