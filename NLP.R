...
library(topicmodels)
x <- readLines("C:/Users/Ronakjhanwar/Desktop/excelr/text mining/shashi.txt")
x
length(x)
...
my_example_text <- readLines("C:/Users/Ronakjhanwar/Desktop/excelr/text mining/shashi.txt")
